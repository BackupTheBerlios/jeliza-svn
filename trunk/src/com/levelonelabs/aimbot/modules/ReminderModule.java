...
public class ReminderModule extends BotModule implements XMLizable {
	...
	private static Logger logger = Logger.getLogger(ReminderModule.class
			.getName());
	...
	public String help() {
		...
		sb
				.append("<B>remember <i>TEXT</i></B> (stores text in the system for retrieval later)\n");
		sb
				.append("<B>forget <i>All or #</i></B> (removes all items or a specific item)\n");
