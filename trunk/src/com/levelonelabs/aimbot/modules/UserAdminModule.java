...
public class UserAdminModule extends BotModule {
	...
	public String help() {
		...
		sb
				.append("<B>rmuser <i>BUDDY</i></B> (removes a user from the list)\n");
		sb.append("<B>denyuser <i>BUDDY</i></B> (deny a user *ADMIN ONLY*)\n");
		sb
				.append("<B>permituser <i>BUDDY</i></B> (permit a user *ADMIN ONLY*)\n");
		sb
				.append("<B>permitmode <i>[MODE]</i></B> (set or display the permitmode*ADMIN ONLY*)\n");
		return sb.toString();
	}
