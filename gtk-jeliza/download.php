...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="de" lang="de" dir="ltr">
	<head>
		...
		<meta name="keywords" content="Michelle Wie,Michelle Wie,Lizenzbestimmungen,Quellenangaben,Urheberrechte beachten,Michelle Wie,Liste der IPA-Zeichen,Sonderzeichen" />
		...
		<title>Bearbeiten von Michelle Wie - Wikipedia</title>
...
var wgPageName = "Michelle_Wie";
var wgTitle = "Michelle Wie";
var wgArticleId = "788962";
...
<body  class="mediawiki ns-0 ltr page-Michelle_Wie">
	<div id="globalWrapper">
		<div id="column-content">
	<div id="content">
		<a name="top" id="top"></a>
				<h1 class="firstHeading">Bearbeiten von Michelle Wie</h1>
		<div id="bodyContent">
...
<form id="editform" name="editform" method="post" action="/w/index.php?title=Michelle_Wie&amp;action=submit" enctype="multipart/form-data">
<input type='hidden' value="" name="wpSection" />
<input type='hidden' value="20070406123005" name="wpStarttime" />

<input type='hidden' value="20070130171658" name="wpEdittime" />
...
cols='80' >[[Bild:Michelle Wie.jpg|thumb|Michelle Wie]]
'''Michelle Wie''' (* [[11. Oktober]] [[1989]] in [[Honolulu]], [[Hawaii]]; eigentlich ''Wie Sung-mi'', [[Koreanische Sprache|koreanisch]] 위성미) ist eine [[USA|US-amerikanische]] [[Golf (Sport)|Golfspielerin]]. 

Das Kind koreanischer Eltern begann im Alter von vier Jahren Golf zu spielen. Mit elf Jahren hatte Wie bereits eine Bestleistung von 64 Schlägen auf 18 Loch und qualifizierte sich in jenem Jahr für die ''Women's U.S. Amateur Public Links Championship'', welche sie mit den [[Golfschläger|Golfschlägern]] ihrer Großmutter bestritt.

Im Jahr 2002 spielte Wie ihr erstes [[LPGA Tour|LPGA]]-Turnier, ein Jahr später gewann sie als jüngste Golferin der Geschichte die ''Women's Amateur Public Links''. 2004 startete sie erstmals bei einem Herrenturnier der [[PGA TOUR]], den ''Sony Open'' in [[Hawaii]] und verfehlt den [[Golf (Sport)|Cut]] nur um einen Schlag.

Seit ihrem 16. Geburtstag ist sie [[Berufsgolfer]]in, reguläres Mitglied der [[LPGA Tour]] kann sie jedoch erst im Alter von 18 Jahren werden. Dennoch hat sie bereits einen Werbevertrag abgeschlossen, der sie mit einer [[Gage]] von 35 Millionen Euro/Jahr zu einer der reichsten Sportlerinnen der Welt macht.

Am 5. Mai 2006 schaffte sie als zweite Frau nach [[Se Ri Pak]] (im Jahr 2003) – und als jüngste Person überhaupt – den Cut in einem Herrenturnier der [[Asian Tour]], den ''SK Telecom Open'' in [[Südkorea]]. Anfang September 2006 spielte sie auf Einladung beim [[Omega European Masters]], einem Turnier der großen [[European Tour]]. Nach zwei Runden lag Wie 15 Schläge über [[Golf (Sport)#Par|Par]] und belegte den letzten Platz. Eine Woche später spielte sie − wieder eingeladen – auf der nordamerikanischen [[PGA TOUR]], beim ''84 LUMBER Classic'', und landete mit 14 Schlägen über Par erneut ganz am Ende des Feldes.

== Weblinks ==
* [http://www.michellewie.com/ Offizielle Homepage]

{{Personendaten|
 NAME=Wie, Michelle
|ALTERNATIVNAMEN=Wie Sung-mi
...
[[Kategorie:Frau|Wie, Michelle]]
[[Kategorie:Golfer (Vereinigte Staaten)|Wie, Michelle]]
[[Kategorie:Geboren 1989|Wie, Michelle]]
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Änderungen zeigen" accesskey="v" title="Zeigt Änderungen am Text tabellarisch an [v]" />
	<span class='editHelp'><a href="/wiki/Michelle_Wie" title="Michelle Wie">Abbrechen</a> | <a target="helpwindow" href="/wiki/Hilfe:Bearbeitungshilfe">Bearbeitungshilfe</a> (wird in einem neuen Fenster geöffnet)</span>
</div><!-- editButtons -->
...
</p></div><ul><li><a href="/wiki/Vorlage:%21" title="Vorlage:!">Vorlage:!</a> (schreibgeschützt)</li><li><a href="/wiki/Vorlage:%21%21" title="Vorlage:!!">Vorlage:!!</a> (schreibgeschützt)</li><li><a href="/wiki/Vorlage:Personendaten" title="Vorlage:Personendaten">Vorlage:Personendaten</a> (schreibgeschützt)</li></ul>
</div>

<input type='hidden' value="\" name="wpEditToken" />
<input name="wpAutoSummary" type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" /></form>
<div class="printfooter">
Von „<a href="http://de.wikipedia.org/wiki/Michelle_Wie">http://de.wikipedia.org/wiki/Michelle_Wie</a>“</div>
						<!-- end content -->
	...
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
					 <li id="ca-nstab-main" class="selected"><a href="/wiki/Michelle_Wie" title="Seiteninhalt anzeigen [c]" accesskey="c">Artikel</a></li>
					 <li id="ca-talk" class="new"><a href="/w/index.php?title=Diskussion:Michelle_Wie&amp;action=edit" title="Diskussion zum Seiteninhalt [t]" accesskey="t">Diskussion</a></li>
					 <li id="ca-edit" class="selected"><a href="/w/index.php?title=Michelle_Wie&amp;action=edit" title="Seite bearbeiten. Bitte vor dem Speichern die Vorschaufunktion benutzen. [e]" accesskey="e">Seite bearbeiten</a></li>
					 <li id="ca-history"><a href="/w/index.php?title=Michelle_Wie&amp;action=history" title="Frühere Versionen dieser Seite [h]" accesskey="h">Versionen/Autoren</a></li>
				</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/w/index.php?title=Spezial:Anmelden&amp;returnto=Michelle_Wie" title="Sich einzuloggen wird zwar gerne gesehen, ist aber keine Pflicht. [o]" accesskey="o">Anmelden</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/wiki/Spezial:Verweisliste/Michelle_Wie" title="Liste aller Seiten, die hierher zeigen [j]" accesskey="j">Links auf diese Seite</a></li>
				<li id="t-recentchangeslinked"><a href="/wiki/Spezial:%C3%84nderungen_an_verlinkten_Seiten/Michelle_Wie" title="Letzte Änderungen an Seiten, die von hier verlinkt sind [k]" accesskey="k">Änderungen an verlinkten Seiten</a></li>
...
<!-- Served by srv113 in 0.410 secs. --></body></html>
